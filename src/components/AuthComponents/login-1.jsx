        ...
        <div className="relative w-full lg:w-1/2 px-8 py-16">
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/60">Sign in to continue your journey</p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 border border-white/10 rounded-lg px-4 py-3 text-sm text-white bg-white/5 hover:bg-white/10 hover:border-purple-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                {googleLoading ? (
                  <Loader className="animate-spin h-5 w-5" />
                ) : (
